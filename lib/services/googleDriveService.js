...
export const googleDriveService = {
  ...
  // Can take a while for many files — long timeout, and safe to retry (an
  // already-emptied flat folder is just skipped on the next run).
  reorganizeIntoCompanyFolders: async (companyGuid) => {
    const res = await api.post("/admin/google-drive/reorganize", { companyGuid }, { timeout: 300000 });
    return res.data;
  },
};
