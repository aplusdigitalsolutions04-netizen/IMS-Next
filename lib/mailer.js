...
async function deliver({ companyGuid, purpose = "general", accountGuid, to, cc, bcc, subject, body, attachments }) {
...
export async function sendMail({ companyGuid, purpose = "general", accountGuid, to, cc, bcc, subject, body, attachments }) {
  const info = await deliver({ companyGuid, purpose, accountGuid, to, cc, bcc, subject, body, attachments });
...
export async function sendWarrantyEmail({ companyGuid, purpose = "warranty", accountGuid, to, cc, bcc, subject, body, attachments }) {
  return sendMail({ companyGuid, purpose, accountGuid, to, cc, bcc, subject, body, attachments });
}
