...
//
// UPLOAD_DIR, when set, points this at a folder outside the app's own
// deploy directory (e.g. /home/<user>/storage on Hostinger) — that path
// isn't touched by a git-based redeploy, so uploads survive across deploys.
// Falls back to <cwd>/uploads (fine for local dev) if unset.
