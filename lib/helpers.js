...
const ALL_PERMISSION_IDS = [
  ...
  "companyMaster","platformMaster","deliveryPartnerMaster","clientMaster","carePackMaster","contracts","emailAccounts","emailTemplates","emailInbox",
  "sentEmails","apiLogs","backupRestore","rateLimitSettings","aiSettings","googleDrive","deletedItems",
];
const MASTER_KEYS = ["category", "brand", "vendor", "item", "variant", "combo", "unit", "mapping"];
...
const FULL_CRUD_KEYS = ["roles", "companyMaster", "platformMaster", "deliveryPartnerMaster", "clientMaster", "carePackMaster", "users", "emailAccounts", "emailTemplates"]
...
const ALL_EDIT_KEYS = [
  ...
  "allow_manage_platform_fields","allow_add_serial","allow_add_nonserialized_stock","allow_transfer_variant",
  ...MASTER_EDIT_KEYS,
  ...FULL_CRUD_KEYS,
];

export const parseJsonArray = (val) => {
  try {
