...
// of routes where deletion is intentionally Admin-only regardless of
// edit-flag (isSuperUser already bypasses everything above, so this only
// fires for non-Admin DELETEs).
